...
def main():
    csv_path = os.path.join(RESULTS_DIR, "detalhamento_predicoes_v1_v2.csv")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_DIR, "matriz_confusao_comparativa.png"))
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(RESULTS_DIR, "curva_roc_comparativa.png"))
    plt.close()
